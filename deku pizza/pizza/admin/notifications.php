...
$sql="select  email,description,time_stamp from admin_notification";
                 ...
                 <form action= "notifications.php" method= "post">
                    ...
                    <hr class="mb-4">
						...
						{while($row =$result-> fetch_assoc()){
								echo "<tr><td>". $row["email"]."</td> <td>".$row["description"]."</td><td>".$row["time_stamp"]."</td></tr>";
						}
        echo"</table>";
						}
         else { echo "0 result";
					...
					?>
                        ...
                        <div class= "row text-center">
                          <div class= "col-md-12 align-self-center">
						     <a href="logs.php" input type= "submit" class= "btn btn-danger"> detail</a>
                             <a href="delete.php"
